...
# Summary
`dcTMD` is a Python package designed to extract free-energy and non-equilibrium friction estimates from targeted molecular dynamics (TMD) simulations [@Schlitter1994_TMD]. The method implemented here is called *dissipation-corrected targeted molecular dynamics* (dcTMD) by @Wolf2018_dcTMD.
