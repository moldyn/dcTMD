...
- **dcTMD Analysis:** In section [dcTMD via Work](tutorials/work.ipynb) and [dcTMD via Force](tutorials/force.ipynb) you will learn how to analyse the constraint pulling trajectories with dcTMD as described in [Theory](tutorials/theory.md). In section [Force correlation analysis](tutorials/force_correlation.ipynb) you will learn how to analyse force force correlation functions at specified time points. And in section [Cluster trajectories](tutorials/create_featureset.ipynb) you find a quick guide on reading in features and clustering trajectories.
